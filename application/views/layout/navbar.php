                                  ...
                                  <a href="#" class="search-toggle dropdown-toggle  d-flex align-items-center" id="dropdownMenuButton4"
                                      data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <?php if ($user['foto'] != null) { ?>
                                            <img src="<?= base_url('public/' . $user['foto']) ?>" class="img-fluid rounded-circle" alt="user">
                                        <?php } else { ?>
                                            <img src="<?= base_url('public/local_assets/images/user_default.png') ?>" class="img-fluid rounded-circle" alt="user">
                                        <?php } ?>
                                      <div class="caption ml-3">
                                          <h6 class="mb-0 line-height"><?= $user['nama'] ?><i class="las la-angle-down ml-2"></i></h6>
                                      </div>
                                  </a>                            
