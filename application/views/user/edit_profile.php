                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs nav-tabs-scroll" id="myTab-two" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="home-tab-two" data-toggle="tab" href="#personal-information" role="tab" aria-selected="true">Personal Information</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="profile-tab-two" data-toggle="tab" href="#change-pwd" role="tab" aria-selected="false">Change Password</a>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content" id="myTabContent-1">
                                    ...
                                    <div class="tab-pane fade" id="change-pwd" role="tabpanel" aria-labelledby="profile-tab-two">
                                        <div class="row ml-1 mt-3 mb-5">
                                        ...
                                        <form>
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="password" class="form-control <?= !empty($errors['cpassword']) ? 'is-invalid' : '' ?> border-radius-top-left-5 border-radius-bottom-left-5" name="cpassword" id="cpassword" aria-label="Current Password" aria-describedby="basic-addon4">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text border-left-0 border-radius-top-right-5 border-radius-bottom-right-5" onclick="togglePassword('cpassword')">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="password" class="form-control <?= !empty($errors['npassword']) ? 'is-invalid' : '' ?> border-radius-top-left-5 border-radius-bottom-left-5" name="npassword" id="npassword" aria-label="New Password" aria-describedby="basic-addon4">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text border-left-0 border-radius-top-right-5 border-radius-bottom-right-5" onclick="togglePassword('npassword')">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="password" class="form-control <?= !empty($errors['vpassword']) ? 'is-invalid' : '' ?> border-radius-top-left-5 border-radius-bottom-left-5" name="vpassword" id="vpassword" aria-label="Verify Password" aria-describedby="basic-addon4">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text border-left-0 border-radius-top-right-5 border-radius-bottom-right-5" onclick="togglePassword('vpassword')">
...
<script>
    function togglePassword(id) {
        ...
        const icon = document.getElementById(`toggleIcon${id.charAt(0).toUpperCase() + id.slice(1)}`);

        const isPassword = input.type === 'password';
        input.type = isPassword ? 'text' : 'password';
        icon.classList.toggle('la-eye', !isPassword);
        icon.classList.toggle('la-low-vision', isPassword);
    }
