        ...
        <div class="content-page">
            <div class="container-fluid">
                <div class="row m-sm-0 px-3">            
                                ...
                                <ul class="list-inline p-0 m-0">
                                    ...
                                    <li class="mb-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <p class="mb-0"><?= date('d F Y', strtotime($user['tanggal_lahir'])) ?></p>                                            </p>   
                                        </div>
                                    </li>
                                    <li class="mb-2">
                                        <div class="d-flex align-items-center">
                    ...
                    <div class="col-lg-8">
                    <div class="card card-block card-stretch bottom-right p-3 shadow-showcase">
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <ul class="list-inline p-0 m-0">
                                            ...
                                            <div class="d-flex align-items-center pt-2">
                                                <img src="<?= base_url('public/template_assets/images/profile/service/01.png') ?>" class="img-fluid" alt="image">
                                            ...
                                            <li class="mb-4">
                                            <div class="d-flex align-items-center pt-2">
                                                <img src="<?= base_url('public/template_assets/images/profile/service/02.png') ?>" class="img-fluid mr-3" alt="image">
                                                <div class="ml-3 w-100">
                                                    <div class="media align-items-center justify-content-between">
                                            ...
                                            <li>
                                            <div class="d-flex align-items-center pt-2">
                                                <img src="<?= base_url('public/template_assets/images/profile/service/03.png') ?>" class="img-fluid" alt="image">
                                                <div class="ml-3 w-100">
                                                    <div class="media align-items-center justify-content-between">
                                                        <p class="mb-0">Adobe Photoshop</p>
                                                        <h6>85%</h6>
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="list-inline p-0 m-0">
                                            <li class="mb-4">
                                            <div class="d-flex align-items-center pt-2">
                                                <img src="<?= base_url('public/template_assets/images/profile/service/04.png') ?>" class="img-fluid" alt="image">
                                                <div class="ml-3 w-100">
                                                    <div class="media align-items-center justify-content-between">
                                                        <p class="mb-0">Adobe Photoshop</p>
                                                        <h6>85%</h6>
                                            ...
                                            <li class="mb-4">
                                            <div class="d-flex align-items-center pt-2">
                                                <img src="<?= base_url('public/template_assets/images/profile/service/05.png') ?>" class="img-fluid" alt="image">
                                                <div class="ml-3 w-100">
                                                    <div class="media align-items-center justify-content-between">
                                                        <p class="mb-0">Figma</p>
                                                        <h6>85%</h6>
                                            ...
                                            <li>
                                            <div class="d-flex align-items-center pt-2">
                                                <img src="<?= base_url('public/template_assets/images/profile/service/06.png') ?>" class="img-fluid" alt="image">
                                                <div class="ml-3 w-100">
                                                    <div class="media align-items-center justify-content-between">
                                                        <p class="mb-0">Adobe Photoshop</p>
                                                        <h6>85%</h6>
