        ...
        <div class="container-fluid">
            <div class="row m-sm-0">
                <div class="col-lg-12 mb-1">
                    <div class="row">
                        <div class="col-lg-3">
                            <a href="<?= base_url('admin/shipping_status') ?>" class="btn bg-secondary-light mb-1"><span class="text-dark d-flex align-items-center">Shipping Settings <i class="las la-angle-right font-size-20"></i></span></a>
                        </div>
                        <div class="col-lg-3">
                            <a href="<?= base_url('admin/order_settings_cnc') ?>" class="btn bg-primary-light mb-1"><span class="text-dark d-flex align-items-center">CNC Settings <i class="las la-angle-right font-size-20"></i></span></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-4 text-sm-right">
                                    <a href="<?= base_url('admin/order_list_today') ?>" class="btn btn-white link-shadow"><span class=" text-primary d-flex align-items-center">Order Today <i class="las la-angle-right font-size-20"></i></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-0">
                            <ul class="list-unstyled row top-projects payment mb-0">
                                ...
                                <?php foreach ($payment_stats as $status => $item): ?>
                                    ...
                                    ?>
                                    <li class="col-lg-4">
                                        <?= form_open('admin/order_list', ['method' => 'post', 'class' => 'payment-form']) ?>
                        ...
                        <div class="card-body p-0">
                            <ul class="list-unstyled row top-projects order mb-0">
                                ...
                                <?php foreach ($order_stats as $status => $item): ?>
                                    ...
                                    <li class="col-lg-4">                               
                                        <?= form_open('admin/order_list', ['method' => 'post', 'class' => 'order-form']) ?>
