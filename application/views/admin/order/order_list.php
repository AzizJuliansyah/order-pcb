                                                ...
                                                <div class="form-group rounded">
                                                    ...
                                                    <div class="border-top ml-3 mr-3">
                                                        <div class="mt-2 d-flex justify-content-end">
                                                            <a href="<?= base_url('admin/order_detail/' . encrypt_id($item['order_id'])) . '?from=list' ?>" class="btn btn-primary font-size-14 d-flex align-items-center pr-0">
                                ...
                                <tbody>
                                    <?php foreach ($orders as $index => $item) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('admin/order_detail/' . encrypt_id($item['order_id'])) . '?from=list' ?>" class="btn btn-primary font-size-12 pr-0">
                                                    Detail Pesanan
                                                    <i class="las la-angle-right"></i>
                                                </a>
                                            </td>
