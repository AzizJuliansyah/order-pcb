                            ...
                            <div class="col-lg-6 bg-<?= ($blog_status == 'new') ? 'primary' : 'warning' ?> content-left">
                                <div class="p-3">
                                    <div class="col-12 pl-0">
                                        <?php if ($blog_status == 'new') { ?>
                                            <h4 class="mb-3 text-white">Blog Berhasil Dibuat!</h4>
                                        <?php } else { ?>
                                            <h4 class="mb-3 text-dark">Blog Berhasil Diubah!</h4>
                                        <?php } ?>
                                    </div>
                                    ...
                                    <div class="d-inline-block w-100">
                                        <a href="<?= base_url('blog/blog_list') ?>" class="btn btn-white mt-3">Periksa daftar blog anda</a>
                                    </div>
                                </div>
                            </div>
