                    ...
                    <div class="card bottom-right shadow-showcase">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="uploader-file file-drag">
                                        ...
                                        <label class="file-label">
                                            ...
                                            <span class="start-one">
                                                ...
                                                <span class="not-image hidden text-danger">Please select image</span>
                            ...
                            <div class="row col-12 col-lg-10 mb-3 p-0">
                                ...
                                <div class="form-group col-lg-10 mb-0">
                                    <input type="text" class="form-control border-radius-5 max-height-40 <?= !empty($errors['title']) ? 'is-invalid' : '' ?>" name="title" id="title" value="<?= isset($old['title']) ? $old['title'] : '' ?>">
                            ...
                            <div class="row col-12 col-lg-10 mb-2 p-0">
                                ...
                                <div class="form-group col-lg-10 mb-0">
                                    <textarea contenteditable="true" name="content" id="content" class="<?= !empty($errors['content']) ? 'is-invalid' : '' ?>" cols="30" rows="10"><?= isset($old['content']) ? $old['content'] : '' ?></textarea>
